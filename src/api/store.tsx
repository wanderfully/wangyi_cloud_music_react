...
// // 开始播放当前列表
// export const playCurrPlaylist = (songs:any, index = 0) => {
//   return (dispatch:any, getState:any) => {
//     // 1. 将歌添加到播放列表中
//     dispatch(
//       addToPlaylist({
